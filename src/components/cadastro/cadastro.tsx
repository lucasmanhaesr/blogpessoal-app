        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
            ...
            <form className='flex justify-center items-center flex-col w-2/3 gap-3' >
                ...
                <div className="flex justify-around w-full gap-8">
                    <Link to={"/"} className='rounded text-white text-center bg-red-400 hover:bg-red-700 w-1/2 py-2'>Cancelar</Link>
                    <button type='submit' className='rounded text-white bg-indigo-400 hover:bg-indigo-900 w-1/2 py-2 flex justify-center' >Cadastrar</button>
                </div>
            </form>
      </div>
    </>
