...
export default function FormPostagem() {
    ...
    async function buscarTemaPorId(id: string) {
        try {
            await buscar(`/tema?id=${id}`, setTema, {
                headers: { Authorization: token }
            })
        } catch (error: any) {
            if (error.toString().includes('403')) {
        ...
        <div className="container flex flex-col mx-auto items-center">
            ...
            <form className="flex flex-col w-1/2 gap-4" onSubmit={gerarNovaPostagem
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="Titulo" name="titulo" required className="border-2 border-slate-700 rounded p-2"
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="Texto" name="texto" required className="border-2 border-slate-700 rounded p-2"
